...
export default class Interior extends Component{
      ...
      constructor(props){
        ...
        this.state = {
          ...
          alt: this.props.navigation.state.params.alt,
          atencion: this.props.navigation.state.params.atencion,
          data: []
        }
      }
        ...
        return(
          <ScrollView style={{backgroundColor:"#ffffff"}}>
            ...
            <View>
                ...
                <List dataArray={this.state.services}
                renderRow={(item,index) =>
                        <ListItem icon key={index}>
                            <Left>
                                <Icon name="checkmark" style={{color:"#27ae60", fontSize:12}} />
                            </Left>
                            <Body>
                                <Text>{item.name}</Text>
                            </Body>
                ...
                <List dataArray={this.state.atencion}
                renderRow={(item,index) =>
                        <ListItem icon key={index}>
                            <Left>
                                <Icon name="checkmark" style={{color:"#27ae60", fontSize:12}} />
            ...
            <View>
                ...
                <Grid style={{marginTop:10}}>
                    <Col>
                        <Button iconLeft full style={{padding:20,height:60,backgroundColor:"#16a085"}} onPress={() => phonecall(this.state.phone,true)}>
